pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = '755952719952.dkr.ecr.eu-west-1.amazonaws.com/dc-parking-mebo'
        ...
        stage('Configure') {
            steps {
                sh """
                    ...
                    echo 'prediction_url_time=http://prod-tomcat-elaborations.cf5sp37dvf.eu-west-1.elasticbeanstalk.com/parking-forecast/predictions?minutes='>>.env
                    echo 'prediction_url_station=http://prod-tomcat-elaborations.cf5sp37dvf.eu-west-1.elasticbeanstalk.com/parking-forecast/lotprediction?pid='>>.env
                    echo 'parking_url_stations=http://ipchannels.integreen-life.bz.it/parkingFrontEnd/rest/get-stations' >> .env
