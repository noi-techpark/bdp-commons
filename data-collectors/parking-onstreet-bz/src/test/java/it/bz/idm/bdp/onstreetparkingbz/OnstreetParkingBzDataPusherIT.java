...
public class OnstreetParkingBzDataPusherIT {
    ...
    public void testPushController() {
        ...
        try {
            ...
            String jsonStr = OnstreetParkingBzDataConverterTestIT
                    .getTestData(OnstreetParkingBzDataConverterTestIT.DATA_PUSH_MEASUREMENTS_2, null, null);
