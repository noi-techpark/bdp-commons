...
def get_odh_stations(origin):
    ODH_URL = "https://mobility.api.opendatahub.bz.com/v2/flat%2Cnode/EChargingStation/%2A/latest?limit=0&offset=0&shownull=false&where=sactive.eq.true,sorigin.eq." + \
