...
public class BikesharingMoqoDataTypes {

    private static final Logger LOG = LogManager.getLogger(BikesharingMoqoDataTypes.class.getName());
    ...
    public BikesharingMoqoDataTypes() {
